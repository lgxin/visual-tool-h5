...
export default function Scaleplate({direction,multiple=1}) {
    ...
    const type =  direction === 'up' ? styles.calibration_up : styles.calibration_left;
    return <div className={`${styles.calibration} ${type}`} ref={calibrationRef}>
    </div>
}